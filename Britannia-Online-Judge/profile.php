...
?>
<br><br><br><div class=""><h3 style="text-align:center; margin-top:30px"><?php  echo"$username's  Profile"; ?></h3></div><br><br>
</div>
...
<div class="ym">
 <div class="pc" style="font-weight: bold; font-size:18px; color: #760448">Information</div><br>
